...
// 数据库相关 (mysql 连接时)
define('UC_DBHOST', getenv('HTTP_BAE_ENV_ADDR_SQL_IP').':'.getenv('HTTP_BAE_ENV_ADDR_SQL_PORT'));			// UCenter 数据库主机
define('UC_DBUSER', getenv('HTTP_BAE_ENV_AK'));				// UCenter 数据库用户名
define('UC_DBPW', getenv('HTTP_BAE_ENV_SK'));				// UCenter 数据库密码
define('UC_DBNAME', '请输入百度云平台的数据库名');				// UCenter 数据库名称
