 ...
 *
 */
$_config['db'][1]['dbhost']  		= getenv('HTTP_BAE_ENV_ADDR_SQL_IP').':'.getenv('HTTP_BAE_ENV_ADDR_SQL_PORT');
$_config['db'][1]['dbuser']  		= getenv('HTTP_BAE_ENV_AK');
$_config['db'][1]['dbpw'] 	 	= getenv('HTTP_BAE_ENV_SK');
$_config['db'][1]['dbcharset'] 		= 'utf8';
$_config['db'][1]['pconnect'] 		= 0;
$_config['db'][1]['dbname']  		= '请输入百度云平台的数据库名';
$_config['db'][1]['tablepre'] 		= 'pre_';
$_config['bucket'] = '请输入百度云存储名';
