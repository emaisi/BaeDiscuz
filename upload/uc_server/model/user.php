...
class usermodel {
	...
	function delete_useravatar($uidsarr) {
		...
		foreach((array)$uidsarr as $uid) {
			UC::file()->file_exists($avatar_file = UC_DATADIR.'./avatar/'.$this->base->get_avatar($uid, 'big', 'real')) && UC::file()->unlink($avatar_file);
			UC::file()->file_exists($avatar_file = UC_DATADIR.'./avatar/'.$this->base->get_avatar($uid, 'middle', 'real')) && UC::file()->unlink($avatar_file);
			UC::file()->file_exists($avatar_file = UC_DATADIR.'./avatar/'.$this->base->get_avatar($uid, 'small', 'real')) && UC::file()->unlink($avatar_file);
			UC::file()->file_exists($avatar_file = UC_DATADIR.'./avatar/'.$this->base->get_avatar($uid, 'big')) && UC::file()->unlink($avatar_file);
			UC::file()->file_exists($avatar_file = UC_DATADIR.'./avatar/'.$this->base->get_avatar($uid, 'middle')) && UC::file()->unlink($avatar_file);
			UC::file()->file_exists($avatar_file = UC_DATADIR.'./avatar/'.$this->base->get_avatar($uid, 'small')) && UC::file()->unlink($avatar_file);
		}		
	}
