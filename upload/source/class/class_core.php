...
require_once DISCUZ_ROOT.'/bcs/class_bcsfile.php';
...
class core
{
	...
	public static function file() {
		if(!self::$_file) {
			...
			//设置根目录
			$file->set_root_path(DISCUZ_ROOT);
			
			$file->add_remote_dir(DISCUZ_ROOT.'./config/config_global.php');
			$file->add_remote_dir(DISCUZ_ROOT.'./config/config_ucenter.php');
			//设置需要写到云存储的目录
			$file->add_remote_dir(DISCUZ_ROOT.'./data/');
			$file->add_remote_dir(DISCUZ_ROOT.'./uc_client/data/');
				$file->add_remote_dir(DISCUZ_ROOT.'./uc_server/data/');
