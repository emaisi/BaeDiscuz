...
/*
if(@C::file()->file_exists(DISCUZ_ROOT.'./install/index.php') && !DISCUZ_DEBUG) {
	@C::file()->unlink(DISCUZ_ROOT.'./install/index.php');
	if(@C::file()->file_exists(DISCUZ_ROOT.'./install/index.php')) {
